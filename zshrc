...
plugins=(git docker-compose docker fzf gh thefuck colored-man-pages colorize)
...
export PATH="$PATH:/Users/loicchollier/.lmstudio/bin"
. "/Users/loicchollier/.deno/env"
