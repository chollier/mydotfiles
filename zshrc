...
plugins=(vi-mode github docker tmux git rails rake ruby brew bundler coffee colored-man colorize gem  heroku node npm osx nvm zsh-autosuggestions fasd jira yarn)
